// components/admin/bio/AdminBioCard.tsx
...
type EditableFieldKey = "full_name" | "email" | "phone_number";

type AdminBioCardProps = {
  fullName: string;
  email?: string;
  ...
  return (
    ...
    >
      <div className="admin-bio-card__header">
        ...
        <div>
          <span className="admin-bio-card__kicker">Admin Profile</span>
